...
| :--- | :---: | :--- | :--- | :---: | :--- |
| **$W_1$: Comportamiento de Pago Histórico** | **40%** | **$V_{1.1}$: Días de Mora Efectiva** | • 0 a 3 días de mora efectiva (Al día / tolerancia leve)<br>• 4 a 6 días de mora efectiva (Alerta preventiva)<br>• 7 a 10 días de mora efectiva (Umbral de congelamiento)<br>• Más de 10 días de mora efectiva (Mora crítica / Bloqueo) | 100 pts<br>70 pts<br>30 pts<br>0 pts | • Tolerancia operativa leve tras plazo estándar.<br>• Alerta preventiva de retraso.<br>• Umbral directo de congelamiento de fiado según P-Q9 (66.7% de los tenderos aplican congelamiento entre 7 y 10 días de mora).<br>• Mora crítica y transición a bloqueo operativo. |
