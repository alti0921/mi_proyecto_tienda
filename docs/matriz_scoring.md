...
| Dimensión | Peso ($W_i$) | Variable Interna | Criterios Operativos y Escala de Evaluación | Puntaje (0 - 100) | Referencia de Campo (Fase 1) |
| :--- | :---: | :--- | :--- | :---: | :--- |
| **$W_1$: Comportamiento de Pago Histórico** | **40%** | **$V_{1.1}$: Días de Mora Activa** | • 0 - 3 días (Al día / mora mínima)<br>• 4 - 6 días (Alerta preventiva)<br>• 7 - 10 días (Umbral de Congelamiento)<br>• Mayor a 10 días (Mora crítica) | 100 pts<br>70 pts<br>30 pts<br>0 pts | P-Q9: 66.7% congelan nuevo crédito entre 7 y 10 días de mora. |
| **$W_1$: Comportamiento de Pago Histórico** | **40%** | **$V_{1.2}$: Antigüedad de Saldo Pendiente** | • Menor a 30 días de antigüedad<br>• 30 - 59 días de antigüedad<br>• 60 - 90 días (Umbral Cartera Perdida)<br>• Mayor a 90 días (Incobrable) | 100 pts<br>60 pts<br>20 pts<br>0 pts | P-Q12: 73.3% fija la cartera perdida entre 60 y 90 días. |
...
| :---: | :---: | :--- |
| **80 - 100 pts** | **Riesgo Bajo / Clase A** | Crédito aprobado. Sugerencia de incremento de cupo hasta en un 20%. |
